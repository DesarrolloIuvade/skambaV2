                ...
                <div className="space-y-4">
                    {grouped.map(({ estado, tareas }) => (
                        <div key={estado.p_e_ide} className="bg-white dark:bg-zinc-900 rounded-xl border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                            ...
                            {/* Table header */}
                            <div className="grid grid-cols-[28px_1fr_130px_140px_100px] gap-2 px-4 py-2.5 bg-zinc-50 dark:bg-zinc-800/50 border-b border-zinc-200 dark:border-zinc-700 text-xs font-semibold text-zinc-500 uppercase tracking-wide">
                                <span />
                                <span>Tarea</span>
                                <span>Asignado</span>
                                <span>Fecha</span>
